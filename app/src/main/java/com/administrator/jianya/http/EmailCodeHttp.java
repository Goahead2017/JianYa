...
public class EmailCodeHttp {

    private String eMail;
    private EmailCodeCallback emailCodeCallback;

    public EmailCodeHttp(RegisterActivity registerActivity, String eMail){
        this.eMail = eMail;
        this.emailCodeCallback = registerActivity;
    }
    ...
    public  void request() {
        ...
        call.enqueue(new Callback<VerifyBean>() {
            ...
            public void onResponse(@NonNull Call<VerifyBean> call, @NonNull Response<VerifyBean> response) {
                emailCodeCallback.onError(response.body());
            }
