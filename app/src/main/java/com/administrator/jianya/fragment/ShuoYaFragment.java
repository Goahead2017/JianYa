...
import com.administrator.jianya.shuoya.RecyclerViewAdapter;
...
public class ShuoYaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_shuo_ya,container,false);
